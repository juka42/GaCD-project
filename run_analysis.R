...
write_csv(data.subject,"./data.subject.csv")
#checking results
#head(data.subject)
#dim(data.subject)
...
#ok #Extracts only the measurements on the mean and standard deviation for each measurement.
#ok #Uses descriptive activity names to name the activities in the data set
#ok #Appropriately labels the data set with descriptive variable names.
#ok #From the data set in step 4, creates a second, independent tidy data set with the average of each variable for each activity and each subject.
